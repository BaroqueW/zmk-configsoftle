...
static void rotate_canvas_to(lv_obj_t *canvas, lv_display_rotation_t rotation) {
    ...
    lv_draw_sw_rotate(buf_copy, buf, CANVAS_SIZE, CANVAS_SIZE, stride, stride, rotation,
                      CANVAS_COLOR_FORMAT);
}

void rotate_canvas(lv_obj_t *canvas) {
#ifdef CONFIG_NICE_VIEW_DISP_ROTATE_180
    rotate_canvas_to(canvas, LV_DISPLAY_ROTATION_90);
#else
    rotate_canvas_to(canvas, LV_DISPLAY_ROTATION_270);
#endif
}
